...
class _WebDavConfigPageState extends State<WebDavConfigPage> {
  ...
  Future<void> _saveConfig() async {
    ...
    if (mounted) {
      ...
      ToastUtils.showSuccess(context, 'WebDAV 配置已保存');
      // 🌟 返回 true 表示配置成功
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: Icon(
                    _testSuccess ? Icons.check_circle_outline_rounded : Icons.dns_rounded,
                    size: 40, 
                    color: _testSuccess 
              ...
              Text(
                _testSuccess 
                    ? '服务器配置正确，点击下方按钮保存配置'
                    : '将笔记数据同步到坚果云、Nextcloud 或你自己的 NAS 中，实现绝对的数据主权。',
                textAlign: TextAlign.center, 
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        '如果你使用坚果云，服务器地址请填写：\nhttps://dav.jianguoyun.com/dav/\n密码请填写在坚果云网页端生成的"应用授权码"，而不是你的登录密码。',
              ...
              _buildTextField(
                ...
                onChanged: (_) => setState(() => _testSuccess = false),
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      icon: _isTesting
                          ...
                          : Icon(_testSuccess ? Icons.refresh_rounded : Icons.wifi_protected_setup_rounded),
                      label: Text(_isTesting ? '测通中...' : (_testSuccess ? '重新测试' : '测试连接')),
